...
namespace SNIESWebApplication.Controllers
{
    ...
    public class RetiroDisciplinarioController : Controller
    {
        ...
        {
            ViewBag.Contolador = "RetiroDisciplinario";
            var PeriodoIdActual = db.RetirosDisciplinarios.Select(x => new { x.FECHA_PERIODO }).GroupBy(x => x.FECHA_PERIODO).ToList();
            int i = 0;
        ...
        public void CrearPlantillaExcel(string PeriodoIdActual)
        {
            ...
            var lista = db.RetirosDisciplinarios.Where(x => x.FECHA_PERIODO == PeriodoIdActual).ToList();
            CrearExcelT(lista);
        }
