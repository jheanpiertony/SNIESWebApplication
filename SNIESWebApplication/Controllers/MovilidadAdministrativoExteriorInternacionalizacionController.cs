...
namespace SNIESWebApplication.Controllers
{
    ...
    public class MovilidadAdministrativoExteriorInternacionalizacionController : Controller
    {
        ...
        {
            ViewBag.Contolador = "MovilidadAdministrativoExteriorInternacionalizacion";
            var PeriodoIdActual = db.MovilidadAdministrativoExteriorInternacionalizacion.Select(x => new { x.FECHA_PERIODO }).GroupBy(x => x.FECHA_PERIODO).ToList();
            int i = 0;
        ...
        public void CrearPlantillaExcel(string PeriodoIdActual)
        {
            ...
            var lista = db.MovilidadAdministrativoExteriorInternacionalizacion.Where(x => x.FECHA_PERIODO == PeriodoIdActual).ToList();
            CrearExcelT(lista);
        }
